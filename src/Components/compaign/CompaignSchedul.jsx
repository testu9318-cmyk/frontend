        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setNewCampaign({ ...newCampaign, time: e.target.value })
                }
                className="w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setNewCampaign({ ...newCampaign, timezone: e.target.value })
              }
              className="w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700">
                  Based on your audience engagement, we recommend sending
                  between 10:00 AM - 2:00 PM on Tuesday or Thursday.
                </p>
              </div>
            </div>
          </div>
          ...
          {newCampaign.type === "one-time" && (
            <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <p className="text-xs text-gray-600">
                Send this campaign immediately after creation instead of
                scheduling
              </p>
            </div>
          )}
